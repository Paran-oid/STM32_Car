...
const osTimerAttr_t StopWarningTimer_attributes = {
  .name = "StopWarningTimer"
};
...
int main(void)
{
  ...
  StopWarningTimerHandle = osTimerNew(stop_warning_timer, osTimerPeriodic, NULL, &StopWarningTimer_attributes);
