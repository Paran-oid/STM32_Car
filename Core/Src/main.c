...
const osMessageQueueAttr_t carInstructions_attributes = {
  .name = "carInstructions"
};
...
int main(void)
{
  ...
  stopMotorTimerHandle = osTimerNew(stopMotorCallback, osTimerOnce, NULL, &stopMotorTimer_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : MOTOR2_1_Pin */
  GPIO_InitStruct.Pin = MOTOR2_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(MOTOR2_1_GPIO_Port, &GPIO_InitStruct);
