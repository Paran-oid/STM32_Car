...
const osTimerAttr_t BuzzerToggleTimer_attributes = {.name = "BuzzerToggleTimer"};
...
const osSemaphoreAttr_t IRSem_attributes = {.name = "IRSem"};
/* USER CODE BEGIN PV */
...
int main(void)
{
    ...
    BuzzerToggleTimerHandle =
        osTimerNew(buzzer_toggle_callback, osTimerOnce, NULL, &BuzzerToggleTimer_attributes);
