...
const osTimerAttr_t StopMotorTimer_attributes = {
  .name = "StopMotorTimer"
};
/* Definitions for BuzzerToggleTimer */
osTimerId_t BuzzerToggleTimerHandle;
const osTimerAttr_t BuzzerToggleTimer_attributes = {
  .name = "BuzzerToggleTimer"
};
/* Definitions for HTIM3Mutex */
osMutexId_t HTIM3MutexHandle;
const osMutexAttr_t HTIM3Mutex_attributes = {
  .name = "HTIM3Mutex"
};
/* Definitions for IRSem */
osSemaphoreId_t IRSemHandle;
const osSemaphoreAttr_t IRSem_attributes = {
  .name = "IRSem"
};
/* USER CODE BEGIN PV */
...
extern void buzzer_toggle_callback(void *argument);
...
int main(void)
{
  ...
  /* creation of IRSem */
  IRSemHandle = osSemaphoreNew(1, 0, &IRSem_attributes);
  ...
  StopMotorTimerHandle = osTimerNew(stop_motor_callback, osTimerOnce, NULL, &StopMotorTimer_attributes);

  /* creation of BuzzerToggleTimer */
  BuzzerToggleTimerHandle = osTimerNew(buzzer_toggle_callback, osTimerOnce, NULL, &BuzzerToggleTimer_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DEBUG_LD_Pin|MOTOR1_1_Pin|MOTOR1_2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DEBUG_LD_Pin MOTOR1_1_Pin MOTOR1_2_Pin */
  GPIO_InitStruct.Pin = DEBUG_LD_Pin|MOTOR1_1_Pin|MOTOR1_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
